function RRcreateVariableMap (obj)
%RRcreateVariableMap constructs the dictionary from the file KeyValues.txt 
...
obj.RRvariableMap = containers.Map(keySet, valueSet);
